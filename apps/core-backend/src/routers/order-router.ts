...
orderRouter.get("/all/:marketId", asyncHandler(orderController.getAllOrderByMarket));
orderRouter.get("/open/:marketId", asyncHandler(orderController.getAllOpenOrderByMarket));
